...
<div class="addtask">
    <a href="addbudget.php"><button class="btn-add">Add Budget +</button></a>
</div>
<div class="table-list">
    <table border="1px" cellspacing="0">
        ...
        <tr>
            ...
            ?>
                <td><?php echo $cnt; ?></td>
                <td><?php echo number_format($row['allocate_budget']); ?> $</td>
                <td style="max-width: 400px;"><?php echo number_format($row['used_budget']) ?> $</td>
                <td>
