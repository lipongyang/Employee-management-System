...
<div class="contianer">
    ...
    <div class=" boxcontian">
        ...
        <div class="box3">
            ...
            ?>
            <h3 style="color: rgb(106, 117, 241);">$ <?php echo  $formated_buget ?></h>
        </div>
    </div>
    <div class="dashes">
        ...
        <div class="budgetdash">
            ...
            <div class="allocate-spent" style="display: flex; margin-left: 70px;">
                <h3 style="margin-top: 10px;">Allocated</h3>
                <h3 style="margin-left: 45px;">Spent</h3>
            </div>
        </div>
    </div>
    <div class="overal">
