    ...
    <table border="1px" cellspacing="0">
        <thead>
            <tr>
                ...
                <th style="padding-left:10px;padding-right:10px">InStock</th>
                <th style="padding-left:10px;padding-right:10px">Used</th>
        ...
        <tr>
            ...
            ?>
                <td><?php echo $cnt; ?></td>
                <td><img src="images/products/<?php echo $row['image']; ?>" alt="emp-image" width="60px"></td>
                <td><?php echo $row['pd_name']; ?></td>
                <td style="max-width: 400px;text-align:justify"><?php echo $row['pd_usage'] ?></td>
                <td><?php echo $row['instock']; ?></td>
                <td><?php echo $row['used']; ?></td>
                <td>
                    <button class="use-btn" onclick="window.location.href='stock_use.php?id=<?php echo $id ?>'">use</button>
                    <button onclick="window.location.href='updatestock.php?id=<?php echo $id ?>'" class=" btn-update">Update</button>
                    <script language="javascript">
                        function confirmDelete() {
                            if (confirm("Are you sure you want to delete the selected Product?")) {
                                // Redirect the user to the delete script
                                window.location = "delete_stock.php?id=<?php echo $id; ?>";
                            }
                        }
                    </script>
